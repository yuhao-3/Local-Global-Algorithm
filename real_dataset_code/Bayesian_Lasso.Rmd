...
plot_densities <- function(ldens, cols, exclude, gold, threshold = 0.5) {
  vacc <- c()
...
pdf(here("figures",paste("lasso_densities_",dataset_name,".pdf",sep="")), width= 20, height= 9)
...
pdf_data$label <- sprintf("(%g, %g, %g)", pdf_data$a, pdf_data$b, pdf_data$c)




# Create the plot with a white background
p <- ggplot(pdf_data, aes(x = x, y = y, color = label)) +
  geom_line() +
