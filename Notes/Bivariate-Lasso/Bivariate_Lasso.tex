...
\begin{array}{rl}
	...
	+ \int_0^\infty\int_{\infty}^0 \exp\left[ -\frac{1}{2}x^TAx + (\textbf{b}^T - c[1,-1]^T)x \right] d\textbf{x}\\
	& \qquad
	+ \int_0^\infty\int_0^\infty   \exp\left[ -\frac{1}{2}x^TAx + (\textbf{b}^T - c[-1,1]^T)x \right] d\textbf{x}
	+ \int_0^\infty\int_0^\infty   \exp\left[ -\frac{1}{2}x^TAx + (\textbf{b}^T + c\textbf{1}^T)x \right]d\textbf{x}
	...
	+ \int^\infty_0\int^{\infty}_0 \exp\left[ -\frac{1}{2}x^TAx + (b_1-c,-b_2-c)^Tx \right] d\textbf{x}\\
	& \qquad
	+ \int_0^\infty\int_0^\infty   \exp\left[ -\frac{1}{2}x^TAx + (-b_1-c,b_2-c)^Tx \right] d\textbf{x}
	...
	+ \int^\infty_0\int^{\infty}_0 \exp\left[ -\frac{1}{2}(x^TAx -2 (b_1-c,-b_2-c)^Tx) \right] d\textbf{x}\\
	& \qquad
	+ \int_0^\infty\int_0^\infty   \exp\left[ -\frac{1}{2}(x^TAx -2 (-b_1-c,b_2-c)^Tx) \right] d\textbf{x}
	...
	\\ [2ex]
	&
	= \int_0^\infty\int_0^\infty    \exp\left[ -\frac{1}{2}(x-\mu_1)^T\Sigma^{-1}(x-\mu_1) + \frac{(A\mu_1)^T\Sigma(A\mu_1)]}{2} \right] d\textbf{x}\\
	& \qquad	
	+ \int_0^\infty\int_0^\infty    \exp\left[ -\frac{1}{2}(x-\mu_2)^T\Sigma^{-1}(x-\mu_2) + \frac{(A\mu_2)^T\Sigma(A\mu_2)]}{2} \right] d\textbf{x}\\
	& \qquad
	+ \int_0^\infty\int_0^\infty    \exp\left[ -\frac{1}{2}(x-\mu_3)^T\Sigma^{-1}(x-\mu_3) + \frac{(A\mu_3)^T\Sigma(A\mu_3)]}{2} \right] d\textbf{x}\\
	& \qquad	
	+ \int_0^\infty\int_0^\infty    \exp\left[ -\frac{1}{2}(x-\mu_4)^T\Sigma^{-1}(x-\mu_4) + \frac{(A\mu_4)^T\Sigma(A\mu_4)]}{2} \right] d\textbf{x}	
		
	\\ [2ex]
	&	 
	=  2\pi|\Sigma|^{\frac{1}{2}}[\exp\left[ \frac{(A\mu_1)^T\Sigma(A\mu_1)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_1,\Sigma)d\textbf{x}\\
	& \qquad	
	+  \exp\left[ \frac{(A\mu_2)^T\Sigma(A\mu_2)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_2,\Sigma)d\textbf{x}\\
	& \qquad
	+  \exp\left[ \frac{(A\mu_3)^T\Sigma(A\mu_3)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_3,\Sigma)d\textbf{x}\\
	& \qquad	
	+  \exp\left[ \frac{(A\mu_4)^T\Sigma(A\mu_4)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_4,\Sigma)d\textbf{x}]\\
	...
	&	 
	=  2\pi \frac{|\Sigma|^{\frac{1}{2}} |\Sigma|^{-1}}{|\Sigma|^{-1}}  [\exp\left[ \frac{(A\mu_1)^T\Sigma(A\mu_1)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_1,\Sigma)d\textbf{x}\\
	& \qquad	
	+  \exp\left[ \frac{(A\mu_2)^T\Sigma(A\mu_2)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_2,\Sigma)d\textbf{x}\\
	& \qquad
	+  \exp\left[ \frac{(A\mu_3)^T\Sigma(A\mu_3)]}{2} \right] \int_0^\infty\int_0^\infty \phi_2(x;\mu_3,\Sigma)d\textbf{x}\\
	...
	&
	=|\Sigma| (\frac{\int_0^\infty\int_0^\infty \phi_2(x;\mu_1,\Sigma)d\textbf{x}}{\phi_2(A\mu_1,\Sigma^{-1})} + \frac{\int_0^\infty\int_0^\infty \phi_2(x;\mu_2,\Sigma)d\textbf{x}}{\phi_2(A\mu_2,\Sigma^{-1})} + \frac{\int_0^\infty\int_0^\infty \phi_2(x;\mu_3,\Sigma)d\textbf{x}}{\phi_2(A\mu_3,\Sigma^{-1})} + \frac{\int_0^\infty\int_0^\infty \phi_2(x;\mu_4,\Sigma)d\textbf{x}}{\phi_2(A\mu_4,\Sigma^{-1})})
...
\begin{array}{rl}
	...
	& 
	= Z^{-1} 2\pi|\Sigma|^{\frac{1}{2}}[\exp\left[ \frac{(A\mu_1)^T\Sigma(A\mu_1)]}{2} \right] \int_0^\infty\int_0^\infty xx^T\otimes\phi_2(x;\mu_1,\Sigma)d\textbf{x}\\
	& \qquad	
	+ 	\begin{bmatrix}
		1 & -1\\
		-1 & 1\\
	\end{bmatrix} \otimes \exp\left[ \frac{(A\mu_2)^T\Sigma(A\mu_2)]}{2} \right] \int_0^\infty\int_0^\infty xx^T\otimes\phi_2(x;\mu_2,\Sigma)d\textbf{x}\\
	& \qquad
	+ 	\begin{bmatrix}
		1 & -1\\
		-1 & 1\\
	\end{bmatrix}  \otimes  \exp\left[ \frac{(A\mu_3)^T\Sigma(A\mu_3)]}{2} \right] \int_0^\infty\int_0^\infty xx^T\otimes\phi_2(x;\mu_3,\Sigma)d\textbf{x}\\
	& \qquad	
	-  \exp\left[ \frac{(A\mu_4)^T\Sigma(A\mu_4)]}{2} \right] \int_0^\infty\int_0^\infty xx^T\otimes\phi_2(x;\mu_4,\Sigma)d\textbf{x}]\\
	\\
	&
	...
	\\
	&
	=  Z^{-1}|\Sigma|[ \frac{E[\textbf{A}\textbf{A}^T]}{\phi_2(A\mu_1,\Sigma))}
